...
if(isset($_GET['data'])){
	...
	$sql = " SELECT `sampul`, `judul`, `isi`, `tanggal` FROM `berita` WHERE id_berita = $id_berita";
			    	...
			    	if (isset($_SESSION['id_user'])){
					  ...
					  ?>
						...
						<!-- Leave a comment -->
							...
							<form class="form-horizontal" action="index1.php?include=commentlifestyle" method="post">
