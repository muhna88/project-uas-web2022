...
?>
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"style="margin-top:5px;"><i class="far fa-list-alt"></i> Form Edit business</h3>
        <div class="card-tools">
          <a href="index.php?include=business" class="btn btn-sm btn-warning float-right"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
        </div>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
   ...
   <?php }?>
      ...
      action="index.php?include=konfirmasi-edit-business">
        <div class="card-body">
